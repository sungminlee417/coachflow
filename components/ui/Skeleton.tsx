...
export function Skeleton({ className = '' }: SkeletonProps) {
  return (
    <div
      className={`animate-pulse bg-line/70 rounded ${className}`}
      aria-hidden
    />
  )
}
...
export function AssignedItemRowSkeleton() {
  return (
    <div className="bg-surface rounded-xl border border-line p-4 flex items-center justify-between gap-3">
...
export function StatRowSkeleton() {
  return (
    <div className="bg-surface rounded-xl border border-line p-4 flex items-baseline justify-between gap-3">
...
export function SummaryTilesSkeleton({ count = 4 }: { count?: number }) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="bg-surface rounded-xl border border-line p-4 space-y-2">
