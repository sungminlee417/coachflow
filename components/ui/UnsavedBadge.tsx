...
export function UnsavedBadge({ visible }: UnsavedBadgeProps) {
  ...
  return (
    <span
      ...
      className="inline-flex items-center gap-1.5 text-xs font-medium text-amber-700 bg-amber-50 border border-amber-200 px-2 py-1 rounded-full whitespace-nowrap shrink-0"
