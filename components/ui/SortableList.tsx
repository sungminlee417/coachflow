...
export function DragHandle({ attributes, listeners }: DragHandleProps) {
  return (
    <button
      ...
      className="h-8 w-8 flex items-center justify-center text-subtle hover:text-foreground hover:bg-elevated rounded-md cursor-grab active:cursor-grabbing touch-none shrink-0"
    >
