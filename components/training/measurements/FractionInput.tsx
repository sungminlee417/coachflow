  ...
  return (
    <div className="flex items-stretch gap-1.5">
      ...
      <select
        ...
        className="text-sm font-semibold text-foreground bg-surface border border-line rounded-lg px-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 hover:border-subtle transition-colors"
      >
        {FRACTIONS.map(f => (
