      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-500 mb-10 max-w-2xl mx-auto leading-relaxed">
            One platform for coaching and training. Build workouts, manage
            clients, track progress &mdash; whether you coach others, get
            coached, or both.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group rounded-2xl border border-slate-200 p-8 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-50 transition-all">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Create custom workouts with exercises, sets, reps, and rest.
                Save as templates for easy reuse across clients.
              </p>
            </div>
            ...
            <div className="group rounded-2xl border border-slate-200 p-8 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-50 transition-all">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Assign workouts to specific dates. Clients see their weekly
                schedule at a glance with a calendar view.
              </p>
            </div>
            ...
            <div className="group rounded-2xl border border-slate-200 p-8 hover:border-amber-200 hover:shadow-lg hover:shadow-amber-50 transition-all">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Monitor completion rates, weekly streaks, and workout history.
                See how your clients are progressing.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={item.step}
                className="flex gap-6 items-start bg-white rounded-2xl border border-slate-200 p-6 sm:p-8"
              >
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-500 text-lg mb-10">
            Join CoachFlow today. Free forever for individuals.
          </p>
          <Link
            href="/signup"
